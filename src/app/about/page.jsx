      ...
      <div className="flex flex-col gap-[20px] justify-end">
        <div className="flex flex-col gap-[30px]">
          <div className="flex flex-col lg:flex-row gap-[30px] lg:items-center items-start ">
            <div className="flex flex-col gap-[30px]">
              <h1 className="about text-[40px] font-bold text-green-500 ">About Me</h1>
            ...
            <div className="flex flex-wrap gap-[10px] ">
              {frontendSkills.map((skill, i) => (
                <div className="skile cursor-pointer" key={i}>
                  <span className=" flex rounded-full border hover:border-green-500 hover: border-white/20 bg-white/5 px-4 py-2 text-white backdrop-blur transition duration-200 justify-center items-center gap-[10px] hover:text-green-500">
        ...
        <div className="about-bottom overflow-hidden whitespace-nowrap">
          <div className="flex w-max animate-marquee gap-8 mt-[70px]">
            {frontendSkills.map((skill, i) => (
              <span
                key={i}
                className="flex rounded-full border hover:border-green-500  border-white/20 bg-white/5 px-4 py-2 text-white backdrop-blur transition duration-200 justify-center items-center gap-[10px] hover:text-green-500 cursor-pointer"
              >
                <Icon icon={skill.icon} height={30} />
                {skill.name}
              </span>
